      ...
      <>
        <div className="headerContainer">
          <div className="mainContainer">
            <video className="appLogoVideo" autoPlay muted loop>
              <source src="logo.mp4" type="video/mp4" />
              Your browser does not support the video tag.
            </video>
            <div className="appLogo">
              <span className="appLogoText">Coupon Uthao</span>
            </div>
            ...
            <button
                className="addButton"
                onClick={this.handleAddCouponModalToggle} title="Add Coupon"
              >
                Add Coupon
              </button>
              ...
              {!this.props.loggedIn && (
                <button
                  ...
                  onClick={this.handleUserEntryToggle} title="Login"
                >
