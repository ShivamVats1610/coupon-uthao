...
class CouponCard extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      outOfStock: false,
      coponTypeImageUrl: "",
      showAddToCartButton: true // New state to control button visibility
    };
        ...
        <div>
          <div className="cardHeader">
            ...
            <div className="cardHeaderText">
              ...
              <div className="cardSubTitle">
                {this.props.data.category} ({this.props.data.couponType})
              </div>
            </div>
          ...
          <div className="cardBody">
            ...
            <div className="cardRightContent">
              ...
              <div className="cardContentAttributes">
                Product Info: <br />
                <div>{this.props.data.sourceProductID}</div>
              </div>
            </div>
          </div>

          <div className="cardFooter">
            {/* Hide the button using a conditional class */}
            <button className={`endButton${this.state.showAddToCartButton ? "" : " hidden"}`} onClick={this.handleMoreInfoClick}>
              More Info
            </button>
          </div>
        </div>
